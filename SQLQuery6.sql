-- ≈сли нет дубликатов, нам можно сделать уникальные ограничени€ по паспорту
...
BEGIN
    ...
    ELSE
        PRINT 'Ќе добавлен UQ_Client_Passport Ч найдены дубликаты';
END
...
BEGIN
    ...
    ELSE
        PRINT 'Ќе добавлен UQ_Staff_Passport Ч найдены дубликаты';
END
GO